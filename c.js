...
unidad2 = document.addEventListener(`change`, convertir);
...
function convertir() {
    ...
    if (document.getElementById("unidad1").value === "decimal" && document.getElementById("unidad2").value === "decimal") {
        document.getElementById("resultadodos").innerText = `La respuesta es ${numero}`
    }



    if (document.getElementById("unidad1").value === "decimal" && document.getElementById("unidad2").value === "binario") {
        ...
        document.getElementById("resultadodos").innerText = `La respuesta es ${a.join(" ")}`
    ...
    if (document.getElementById("unidad1").value === "decimal" && document.getElementById("unidad2").value === "octal") {
    ...
    if (document.getElementById("unidad1").value === "decimal" && document.getElementById("unidad2").value === "hexadecimal") {
    ...
    if (document.getElementById("unidad1").value === "binario" && document.getElementById("unidad2").value === "binario") {
    ...
    if (document.getElementById("unidad1").value === "binario" && document.getElementById("unidad2").value === "decimal") {
        ...
        for (let i = 0; i < listo.length; i++) {
            ...
            final.push(deci)
            console.log(`los decimales finales son ${final}`);

            let total = final.reduce((a, b) => a + b, 0);

            console.log(`y su suma es ${total}`);

            document.getElementById("resultadodos").innerText = `La respuesta es ${total}`
    ...
    if (document.getElementById("unidad1").value === "binario" && document.getElementById("unidad2").value === "octal") {
        ...
        console.log(a + " cantidad de grupos que se pueden formar de 3");
        let div_pos = nu_pos % 3;

        console.log(div_pos + " residuo de la division en 3");
        let toto = a * 3;
        let i = nu_pos
        console.log(toto + " numagico");
        while (i != toto) {
            liis.unshift(0)
            i++
        }
        ...
        console.log(arra_respuesta);

        let respuestagod = arra_respuesta.join("")

        document.getElementById("resultadodos").innerText = `La respuesta es ${respuestagod}`
    }




    if (document.getElementById("unidad1").value === "binario" && document.getElementById("unidad2").value === "hexadecimal") {
    ...
    if (document.getElementById("unidad1").value === "octal" && document.getElementById("unidad2").value === "decimal") {
        ...
        for (let i = 0; i < vuelt.length; i++) {
            ...
            ele = Math.pow(8, i)
            console.log(`potencias de 8: ${ele}`);

            let cas = lis[i] * ele;
            console.log(`solu: ${cas}`);
        ...
        document.getElementById("resultadodos").innerText = `La respuesta es ${f}`
    ...
    if (document.getElementById("unidad1").value === "octal" && document.getElementById("unidad2").value === "binario") {
        ...
        document.getElementById("resultadodos").innerText = `La respuesta es ${poporespuestagod}`
    ...
    if (document.getElementById("unidad1").value === "octal" && document.getElementById("unidad2").value === "octal") {
    ...
    if (document.getElementById("unidad1").value === "hexadecimal" && document.getElementById("unidad2").value === "decimal") {
        ...
        for (let i = 0; i < rever.length; i++) {
            ...
            document.getElementById("resultadodos").innerText = `La respuesta es ${sum}`
    ...
    if (document.getElementById("unidad1").value === "hexadecimal" && document.getElementById("unidad2").value === "binario") {
        ...
        document.getElementById("resultadodos").innerText = `La respuesta es ${respuestagod_hexabi}`
    ...
    if (document.getElementById("unidad1").value === "hexadecimal" && document.getElementById("unidad2").value === "octal") {
    ...
    if (document.getElementById("unidad1").value === "hexadecimal" && document.getElementById("unidad2").value === "hexadecimal") {
